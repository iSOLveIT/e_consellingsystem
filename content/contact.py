...
def sendEmail(_name, _subject, _email, _body):
    # SEND EMAIL
    _recipient = 'example@gmail.com'
    msg = Message(_subject, sender=('COUNSELLING & GENDER UNIT', 'example@gmail.com'), recipients=[_recipient])
    assert msg.sender == "COUNSELLING & GENDER UNIT <example@gmail.com>"
    msg.body = f'''{_body}
...
def replyMessage(_email, _senderName):
    ...
    mesg = Message(_subj, sender=('COUNSELLING & GENDER UNIT', 'example@gmail.com'), recipients=[_email])
    assert mesg.sender == "COUNSELLING & GENDER UNIT <example@gmail.com>"
...
def reset_password_link(user, email, username):
    ...
    msg = Message(subj, sender=('COUNSELLING & GENDER UNIT', 'example@gmail.com'), recipients=[email_address])
    assert msg.sender == "COUNSELLING & GENDER UNIT <example@gmail.com>"
